package com.apetrovic.tenants.data.config.tenant;

import com.apetrovic.tenants.data.config.tenant.liquibase.DynamicDataSourceBasedMultiTenantSpringLiquibase;
...
public class TenantLiquibaseConfig {
    ...
    public DynamicDataSourceBasedMultiTenantSpringLiquibase dynamicDataSourceBasedMultiTenantSpringLiquibase(
            @Qualifier("masterLiquibaseProperties") LiquibaseProperties liquibaseProperties) {
